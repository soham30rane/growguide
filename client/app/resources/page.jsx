...
const ResourcesPage = () => {
  const [activeTab, setActiveTab] = useState('modules'); // 'modules' or 'blogs'
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-100 p-6 dark:from-[#1e3b2f] dark:via-[#1e3b2f] dark:to-[#1e3b2f]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex p-1 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
            <button
        ...
        {activeTab === 'modules' ? <LearningModulesPage /> : (
          <>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 line-clamp-3">
                  {blog.blogContent.substring(0, 100).replace(/[#*_]/g, '')}...
                </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            <button 
              ...
              className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 mb-4 flex items-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="p-6">
            <div className="prose max-w-none dark:prose-invert prose-green prose-img:rounded-lg prose-headings:text-green-700 dark:prose-headings:text-green-400">
